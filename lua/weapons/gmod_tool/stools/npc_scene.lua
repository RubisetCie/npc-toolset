...
function TOOL.BuildCPanel(CPanel)
	CPanel:Help("#tool.npc_scene.desc")
	local npad = vgui.Create("CtrlNumPad",CPanel)
	npad:SetLabel1("Scene Key")
	npad:SetConVar1("npc_scene_key")
	CPanel:AddPanel(npad)
	CPanel:TextEntry("Scene Name","npc_scene_scene")
	CPanel:TextEntry("Actor Name","npc_scene_actor")
	if game.SinglePlayer() then
		CPanel:ControlHelp("Apply a scene and open the console to see which actor names you need to set.")
	end
	CPanel:NumSlider("Loop","npc_scene_loop",0,100,0)
