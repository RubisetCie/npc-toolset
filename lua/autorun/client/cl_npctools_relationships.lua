...
UpdateMenu = function()
	...
	local rels = vgui.Create("DListView")
	rels:SetMultiSelect(false)
	rels:AddColumn("Relationships")
	for k,v in pairs(options) do
		local line = rels:AddLine(k)
		line.data = v
	...
	rels:SetTall(250)
	rels:SortByColumn(1,false)
	function rels:OnRowSelected(LineID, Line)
		for k,v in pairs(Line.data) do
